...
!-----------------------------------------------
      ...
      use common_arrays_C, only : labels, na, nb, nc, tvec
...
!-----------------------------------------------
      integer :: j, i, mb, mc, ma, k, l
      double precision :: sum, ccos, cosa, xb, yb, zb, rbc, xa, ya, za, xyb, &
...
!***********************************************************************
  ...
  !
              ...
              write(iw, '(10x, a, i5, a, a, 3f12.5)')"Atom", mb, ": ", elemnt(labels(mb)),coord(:,mb)
              write(iw, '(10x, a, i5, a, a, 3f12.5,/)')"Atom", mc, ": ", elemnt(labels(mc)),coord(:,mc) 
  ...
  !
            ...
            if (xyb <= 0.009d0) then 
              ...
              if (xyb < 0.009d0) then
                ...
                write(iw,'(58x, a, 2(11x,a))')"X", "Y", "Z" 
                write(iw, '(10x, a, i5, a, a, 3f12.5)')"Atom", ma, ": ", elemnt(labels(ma)),coord(:,ma)
                write(iw, '(10x, a, i5, a, a, 3f12.5,/)')"Atom", mc, ": ", &
                  elemnt(labels(mc)),coord(:,mc)
                write (iw,'(a)')" Geometry at point of failure:"
                call geout(1) 
                call mopend ('TWO ATOMS ARE COINCIDENT.  A FATAL ERROR.') 
                return   
